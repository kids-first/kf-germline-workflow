...
inputs:
  ...
  aligned_reads: {type: 'File', secondaryFiles: [{pattern: '.bai', required: false},
      ...
      \ CNVs will be discovered", "sbg:fileTypes": "BAM, CRAM"}
...
outputs:
  ...
  gatk_gcnv_genotyped_intervals_vcfs: {type: 'File[]?', outputSource: gatk_gcnv_case/genotyped_intervals_vcfs,
    doc: "Per sample VCF files provides a detailed listing of the most likely copy-number\
      ...
      \ copy-number states."}
  gatk_gcnv_genotyped_segments_vcfs: {type: 'File[]?', outputSource: gatk_gcnv_case/genotyped_segments_vcfs,
  ...
  cnvnator_vcf: {type: 'File?', outputSource: cnvnator/vcf, doc: "Called CNVs in VCF\
      \ format"}
  cnvnator_called_cnvs: {type: 'File?', outputSource: cnvnator/called_cnvs, doc: "Called\
      \ CNVs from aligned_reads"}
  cnvnator_average_rd: {type: 'File?', outputSource: cnvnator/average_rd, doc: "Average\
      \ RD stats"}
steps:
  file_to_file_array:
    hints:
  ...
  gatk_gcnv_case:
    ...
    out: [preprocessed_intervals, read_counts_entity_ids, read_counts, sample_contig_ploidy_calls_tars,
      gcnv_calls_tars, gcnv_tracking_tars, genotyped_intervals_vcfs, genotyped_segments_vcfs,
      denoised_copy_ratios, sample_qc_status_files, sample_qc_status_strings]
