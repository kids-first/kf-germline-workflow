...
outputs:
  ...
  gatk_gcnv_annotated_genotyped_segments: {type: 'File[]?', outputSource: annotsv_gatk_gcnv/annotated_calls, doc: "Per sample TSV
      files containing AnnotSV-annotated CNVs from gatk_gcnv_genotyped_segments_vcfs"}
