...
inputs:
  ...
  ligate_force: { type: 'boolean?', inputBinding: { position: 2, prefix: "--ligate-force"}, doc: "Ligate even non-overlapping chunks, keep all sites" }
  ligate_warn: { type: 'boolean?', inputBinding: { position: 2, prefix: "--ligate-warn"}, doc: "Drop sites in imperfect overlaps" }
