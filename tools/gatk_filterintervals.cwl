...
inputs:
  ...
  lc_filter_count: { type: 'int?', default: 10, doc: "Count-threshold parameter for the low-count filter. Intervals with a count strictly less than this threshold in a percentage of samples strictly greater than low-count-filter-percentage-of-samples will be filtered out. (This is the first count-based filter applied.)" }
  lc_filter_percent: { type: 'float?', default: 50.0, doc: "Percentage-of-samples parameter for the low-count filter. Intervals with a count strictly less than low-count-filter-count-threshold in a percentage of samples strictly greater than this will be filtered out. (This is the first count-based filter applied.)" }
