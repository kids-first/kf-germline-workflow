...
outputs:
  unfiltered_vcf: {type: 'File', outputSource: merge_vcfs/merged_vcf}
  annotated_filtered_vcf: {type: 'File[]', outputSource: annotate_vcf/annotated_vcf}
...
steps:
  ...
  bcftools_view_index:
    ...
    in:
      ...
      output_filename:
        valueFrom: $(inputs.input_vcf.basename.replace(".vcf.gz",".filtered.vcf.gz"))
      output_type:
        valueFrom: "z"
      include:
        valueFrom: "QUAL >= 30"
  ...
  annotate_vcf:
    ...
    in:
      ...
      output_basename: output_basename
      tool_name:
        valueFrom: "freebayes.filtered.vep_105"
